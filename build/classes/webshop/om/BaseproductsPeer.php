...
abstract class BaseproductsPeer
{
    ...
    /** the column name for the beschr field */
    const BESCHR = 'products.beschr';
    ...
    protected static $fieldNames = array (
        BasePeer::TYPE_PHPNAME => array ('Id', 'Beschr', ),
        BasePeer::TYPE_STUDLYPHPNAME => array ('id', 'beschr', ),
        BasePeer::TYPE_COLNAME => array (productsPeer::ID, productsPeer::BESCHR, ),
        BasePeer::TYPE_RAW_COLNAME => array ('ID', 'BESCHR', ),
        BasePeer::TYPE_FIELDNAME => array ('id', 'beschr', ),
    ...
    protected static $fieldKeys = array (
        BasePeer::TYPE_PHPNAME => array ('Id' => 0, 'Beschr' => 1, ),
        BasePeer::TYPE_STUDLYPHPNAME => array ('id' => 0, 'beschr' => 1, ),
        BasePeer::TYPE_COLNAME => array (productsPeer::ID => 0, productsPeer::BESCHR => 1, ),
        BasePeer::TYPE_RAW_COLNAME => array ('ID' => 0, 'BESCHR' => 1, ),
        BasePeer::TYPE_FIELDNAME => array ('id' => 0, 'beschr' => 1, ),
        BasePeer::TYPE_NUM => array (0, 1, )
    );
    ...
    public static function addSelectColumns(Criteria $criteria, $alias = null)
    {
        if (null === $alias) {
            ...
            $criteria->addSelectColumn(productsPeer::BESCHR);
        } else {
            $criteria->addSelectColumn($alias . '.id');
            $criteria->addSelectColumn($alias . '.beschr');
        }
    }
