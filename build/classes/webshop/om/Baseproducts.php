...
abstract class Baseproducts extends BaseObject implements Persistent
{
    ...
    /**
     * The value for the beschr field.
     * @var        string
     */
    protected $beschr;
    ...
    /**
     * Set the value of [beschr] column.
     *
     * @param  string $v new value
     * @return products The current object (for fluent API support)
     */
    public function setBeschr($v)
    {
        if ($v !== null && is_numeric($v)) {
            $v = (string) $v;
        }
        ...
        if ($this->beschr !== $v) {
            $this->beschr = $v;
            $this->modifiedColumns[] = productsPeer::BESCHR;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            $this->beschr = ($row[$startcol + 1] !== null) ? (string) $row[$startcol + 1] : null;
            $this->resetModified();
            ...
            return $startcol + 2; // 2 = productsPeer::NUM_HYDRATE_COLUMNS.
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(productsPeer::BESCHR)) {
            $modifiedColumns[':p' . $index++]  = '`beschr`';
        }
            ...
            foreach ($modifiedColumns as $identifier => $columnName) {
                switch ($columnName) {
                    case '`id`':
                        ...
                        break;
                    case '`beschr`':
                        $stmt->bindValue($identifier, $this->beschr, PDO::PARAM_STR);
                        break;
                }
            }
            $stmt->execute();
    ...
    public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[1], $arr)) $this->setBeschr($arr[$keys[1]]);
    }
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(productsPeer::BESCHR)) $criteria->add(productsPeer::BESCHR, $this->beschr);
    ...
    {
        $copyObj->setBeschr($this->getBeschr());
    ...
    public function initcarts($overrideExisting = true)
    {
        ...
        $this->collcarts = new PropelObjectCollection();
     ...
     * @throws PropelException
     */
    public function getcarts($criteria = null, PropelPDO $con = null)
    {
        ...
        if (null === $this->collcarts || null !== $criteria  || $partial) {
            if ($this->isNew() && null === $this->collcarts) {
                ...
                $collcarts = cartQuery::create(null, $criteria)
     ...
     *
     * @param PropelCollection $carts A Propel collection.
     * @param PropelPDO $con Optional connection object
     * @return products The current object (for fluent API support)
     */
    public function setcarts(PropelCollection $carts, PropelPDO $con = null)
    {
     ...
     * @throws PropelException
     */
    public function countcarts(Criteria $criteria = null, $distinct = false, PropelPDO $con = null)
    {
        $partial = $this->collcartsPartial && !$this->isNew();
        if (null === $this->collcarts || null !== $criteria || $partial) {
            if ($this->isNew() && null === $this->collcarts) {
     ...
     * @return products The current object (for fluent API support)
     */
    public function addcart(cart $l)
    {
        if ($this->collcarts === null) {
            $this->initcarts();
            $this->collcartsPartial = true;
     ...
     * @return PropelObjectCollection|cart[] List of cart objects
     */
    public function getcartsJoinuser($criteria = null, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        $query = cartQuery::create(null, $criteria);
    ...
    public function clearAllReferences($deep = false)
    {
        ...
        if ($this->collcarts instanceof PropelCollection) {
