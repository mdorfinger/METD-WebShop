 ...
 */
abstract class Basecart extends BaseObject implements Persistent
{
    /**
     * Peer class name
     */
    ...
    public function setUserid($v)
    {
        ...
        if ($this->userid !== $v) {
            $this->userid = $v;
            $this->modifiedColumns[] = cartPeer::USERID;
        }
    ...
    public function setProductid($v)
    {
        ...
        if ($this->productid !== $v) {
            $this->productid = $v;
            $this->modifiedColumns[] = cartPeer::PRODUCTID;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            return $startcol + 2; // 2 = cartPeer::NUM_HYDRATE_COLUMNS.
    ...
    public function ensureConsistency()
    {
        ...
        if ($this->aproducts !== null && $this->productid !== $this->aproducts->getId()) {
            $this->aproducts = null;
        }
    } // ensureConsistency
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(cartPeer::USERID)) {
            $modifiedColumns[':p' . $index++]  = '`userID`';
        }
        if ($this->isColumnModified(cartPeer::PRODUCTID)) {
    ...
    {
        if (isset($alreadyDumpedObjects['cart'][serialize($this->getPrimaryKey())])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['cart'][serialize($this->getPrimaryKey())] = true;
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(cartPeer::USERID)) $criteria->add(cartPeer::USERID, $this->userid);
        if ($this->isColumnModified(cartPeer::PRODUCTID)) $criteria->add(cartPeer::PRODUCTID, $this->productid);
    ...
    {
        $criteria = new Criteria(cartPeer::DATABASE_NAME);
        $criteria->add(cartPeer::USERID, $this->userid);
        $criteria->add(cartPeer::PRODUCTID, $this->productid);
    ...
    {
        if ($this->aproducts === null && ($this->productid !== null) && $doQuery) {
            $this->aproducts = productsQuery::create()->findPk($this->productid, $con);
            /* The following can be used additionally to
                guarantee the related object contains a reference
                to this object.  This level of coupling may, however, be
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aproducts->addcarts($this);
             */
        }
